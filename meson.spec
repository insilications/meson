...
Source0  : https://github.com/mesonbuild/meson/releases/download/0.57.0/meson-0.57.0.tar.gz
Source1  : https://github.com/mesonbuild/meson/releases/download/0.57.0/meson-0.57.0.tar.gz.asc
...
%prep
%setup -q -n meson-0.57.0
cd %{_builddir}/meson-0.57.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613409805
...
cp %{_builddir}/meson-0.57.0/COPYING %{buildroot}/usr/share/package-licenses/meson/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/meson-0.57.0/packaging/License.rtf %{buildroot}/usr/share/package-licenses/meson/00dcd169768382e0b6a13d0d110266754fedb62b
