...
Source0  : https://github.com/mesonbuild/meson/releases/download/0.56.2/meson-0.56.2.tar.gz
Source1  : https://github.com/mesonbuild/meson/releases/download/0.56.2/meson-0.56.2.tar.gz.asc
...
%prep
%setup -q -n meson-0.56.2
cd %{_builddir}/meson-0.56.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610301108
...
cp %{_builddir}/meson-0.56.2/COPYING %{buildroot}/usr/share/package-licenses/meson/2b8b815229aa8a61e483fb4ba0588b8b6c491890
