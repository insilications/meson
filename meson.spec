...
Source1  : https://github.com/mesonbuild/meson/releases/download/0.53.1/meson-0.53.1.tar.gz.asc
...
%prep
%setup -q -n meson-0.53.1
cd %{_builddir}/meson-0.53.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579879818
...
cp %{_builddir}/meson-0.53.1/COPYING %{buildroot}/usr/share/package-licenses/meson/2b8b815229aa8a61e483fb4ba0588b8b6c491890
