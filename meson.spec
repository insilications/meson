...
Source0  : https://github.com/mesonbuild/meson/releases/download/0.53.0/meson-0.53.0.tar.gz
Source1  : https://github.com/mesonbuild/meson/releases/download/0.53.0/meson-0.53.0.tar.gz.sig
...
%prep
%setup -q -n meson-0.53.0
cd %{_builddir}/meson-0.53.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578441828
...
cp %{_builddir}/meson-0.53.0/COPYING %{buildroot}/usr/share/package-licenses/meson/2b8b815229aa8a61e483fb4ba0588b8b6c491890
