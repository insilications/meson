...
Source0  : https://github.com/mesonbuild/meson/releases/download/0.54.3/meson-0.54.3.tar.gz
Source1  : https://github.com/mesonbuild/meson/releases/download/0.54.3/meson-0.54.3.tar.gz.asc
...
%prep
%setup -q -n meson-0.54.3
cd %{_builddir}/meson-0.54.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592368159
...
cp %{_builddir}/meson-0.54.3/COPYING %{buildroot}/usr/share/package-licenses/meson/2b8b815229aa8a61e483fb4ba0588b8b6c491890
