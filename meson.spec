...
Version  : 20.08.25
Release  : 63
URL      : file:///insilications/build/clearlinux/packages/meson/meson-20.08.25.zip
Source0  : file:///insilications/build/clearlinux/packages/meson/meson-20.08.25.zip
...
%prep
%setup -q -n meson-20.08.25
cd %{_builddir}/meson-20.08.25
...
unset no_proxy
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598382521
