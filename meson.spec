...
Version  : 0.55.1v
Release  : 64
URL      : file:///insilications/build/clearlinux/packages/meson/meson-0.55.1v.zip
Source0  : file:///insilications/build/clearlinux/packages/meson/meson-0.55.1v.zip
...
%prep
%setup -q -n meson-0.55.1v
cd %{_builddir}/meson-0.55.1v
...
unset no_proxy
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598382732
