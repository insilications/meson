...
Version  : 0.55.1
Release  : 65
URL      : file:///insilications/build/clearlinux/packages/meson/meson-v0.55.1.zip
Source0  : file:///insilications/build/clearlinux/packages/meson/meson-v0.55.1.zip
...
%prep
%setup -q -n meson-v0.55.1
cd %{_builddir}/meson-v0.55.1
...
unset no_proxy
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598382827
